...
export type { ISoulbound } from "./contracts/interfaces/ISoulbound";
export { ISoulbound__factory } from "./factories/contracts/interfaces/ISoulbound__factory";
export type { Soulbound } from "./contracts/Soulbound";
export { Soulbound__factory } from "./factories/contracts/Soulbound__factory";
